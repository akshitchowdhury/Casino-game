...
export default function ImageReels() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-900 bg-opacity-90 text-white p-4">
            ...
            <div className="mt-16 text-lg md:text-xl text-center md:text-left w-full">
                {points === 0 ? (
                    ...
                    <div className="flex flex-col md:flex-row items-center w-[800px] mx-[20%] align-middle justify-center gap-4 p-2 md:p-4 border border-gray-700 rounded-md">
